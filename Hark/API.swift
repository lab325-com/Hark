...
public final class AcceptHarkRequestMutation: GraphQLMutation {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    mutation AcceptHarkRequest($requestId: String!) {
      acceptHarkRequest(requestId: $requestId)
    }
    """

  public let operationName: String = "AcceptHarkRequest"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("acceptHarkRequest", arguments: ["requestId": GraphQLVariable("requestId")], type: .scalar(Bool.self)),
      ]
    }
    ...
    public init(acceptHarkRequest: Bool? = nil) {
      self.init(unsafeResultMap: ["__typename": "Mutation", "acceptHarkRequest": acceptHarkRequest])
    }

    public var acceptHarkRequest: Bool? {
      get {
        return resultMap["acceptHarkRequest"] as? Bool
      }
      set {
        resultMap.updateValue(newValue, forKey: "acceptHarkRequest")
      }
    }
  }
}
